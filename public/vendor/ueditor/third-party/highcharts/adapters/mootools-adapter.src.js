...
// JSLint options:
/*global Fx, $, $extend, $each, $merge, Events, logEvent, DOMEvent */
...
var win = window,
	...
	legacyEvent = legacy || mooVersion === '1.3', // In versions 1.1 - 1.3 the event class is named logEvent, in newer versions it is named DOMEvent.
...
win.HighchartsAdapter = {
	 ...
	 * @param {Function} fn logEvent handler
	 */
